		...
		<div class="container demo-1">
			<div class="content">
				<div id="large-header" class="large-header">
					...
					<h1 class="main-title">Error 
					<span class="thin">
						<?php
						echo $vars;
						?>
					</span>
					<span style="font-size:20px;float:none;color:green;display:block">
						<a href="http://teamfoundation.com/" style="color:yellow" >Go To INDEX PAGE</a>
					</span>
